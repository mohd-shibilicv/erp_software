...
const ClientRequirementsDetails = () => {
  ...
  return (
    ...
    <h2 className="text-3xl font-semibold mb-6">Client Requirement Details</h2>
    
    <div className="flex flex-col md:flex-row mb-8">
      <div className="md:w-1/2 mb-4 md:mb-0 md:pr-4">
        <div className="mb-4">
          <p className="font-semibold">Client Name: <span className="font-normal">{client?.name}</span></p>
        </div>
        <div className="mb-4">
          <p className="font-semibold">File Number: <span className="font-normal">{file_number}</span></p>
        </div>
        <div className="mb-4">
          <p className="font-semibold">Color Theme: <span className="font-normal">{color_theme}</span></p>
        </div>
      </div>
      <div className="md:w-1/2 md:pl-4">
        <div className="mb-4">
          <p className="font-semibold">Layout: <span className="font-normal">{layout}</span></p>
        </div>
        <div className="mb-4">
          <p className="font-semibold">Additional Requirements: <span className="font-normal">{additional_requirements}</span></p>
        </div>
        <div className="mb-4">
          <p className="font-semibold">Status: <span className="font-normal capitalize">{status}</span></p>
        </div>
      </div>
    </div>
