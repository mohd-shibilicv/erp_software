            ...
            <div className="grid grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex justify-between">
                        ...
                        <a href={agreement.tc_file} className="text-blue-500 underline ml-2">Download</a>
                    </div>
                    <div className="flex justify-between">
                        <p className="text-blue-500 font-semibold">Signed Agreement:</p>
                        <a href={agreement.signed_agreement} className="text-blue-500 underline ml-2">Download</a>
                    </div>
                </div>
            </div>

            <h2 className="text-xl font-semibold mt-8 mb-4 text-center">Payment Terms</h2>
