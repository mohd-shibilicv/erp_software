...
const ModalOptions = ({ onClose, items, customerAccount, invoiceNumber, invoiceDate, calculateSubTotal, calculateTotalDiscount, calculateTotalTax }) => {
    ...
    useEffect(() => {
        if (selectedInvoiceType === "noHeaderFooter") {
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            {[
                                ...
                                <div
                                    ...
                                    className={`p-3 border rounded-md cursor-pointer transition-colors ${selectedInvoiceType === type ? 'bg-violet-100 border-violet-400' : 'border-gray-200 hover:bg-gray-50'
                                        }`}
                                >
