...
const InvoiceWithHeader = React.forwardRef(({ items, customerAccount, invoiceNumber, invoiceDate, calculateSubTotal, headerImage, calculateTotalDiscount, calculateTotalTax }, ref) => {
  return (
...
export default InvoiceWithHeader;
