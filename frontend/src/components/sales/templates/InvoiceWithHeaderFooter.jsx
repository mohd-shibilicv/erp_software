...
const InvoiceWithHeaderFooter = React.forwardRef(({ items, customerAccount, invoiceNumber, invoiceDate, calculateSubTotal, headerImage, footerImage, calculateTotalDiscount,calculateTotalTax }, ref) => {
  return (
